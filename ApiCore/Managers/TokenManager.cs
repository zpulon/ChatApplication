...
namespace ApiCore.Managers
{
    public class TokenManager
    {
        ...
        private HttpClientActuator _httpClient = null;
        ...
        {
            _httpClient = ICoreServiceCollectionExtensions.ServiceProvider.GetService(typeof(HttpClientActuator)) as HttpClientActuator;
        ...
        public async Task<string> GetAccessToken()
        {
            if (token == null || token.IsExpired())
            {
                lock (locker)
                {
                    ...
                    BearerToken bt = _httpClient.SubmitForm<BearerToken>(_url, dic).Result;
